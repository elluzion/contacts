...
package com.nwagu.contacts.quickcontact;
...
import com.nwagu.contacts.CallUtil;
import com.nwagu.contacts.ClipboardUtils;
import com.nwagu.contacts.Collapser;
import com.nwagu.contacts.ContactSaveService;
import com.nwagu.contacts.ContactsActivity;
import com.nwagu.contacts.ContactsUtils;
import com.nwagu.contacts.DynamicShortcuts;
import com.nwagu.contacts.NfcHandler;
import com.nwagu.contacts.R;
import com.nwagu.contacts.ShortcutIntentBuilder;
import com.nwagu.contacts.ShortcutIntentBuilder.OnShortcutIntentCreatedListener;
import com.nwagu.contacts.activities.ContactEditorActivity;
import com.nwagu.contacts.activities.ContactSelectionActivity;
import com.nwagu.contacts.activities.RequestPermissionsActivity;
import com.nwagu.contacts.compat.CompatUtils;
import com.nwagu.contacts.compat.EventCompat;
import com.nwagu.contacts.compat.MultiWindowCompat;
import com.nwagu.contacts.detail.ContactDisplayUtils;
import com.nwagu.contacts.dialog.CallSubjectDialog;
import com.nwagu.contacts.editor.ContactEditorFragment;
import com.nwagu.contacts.editor.EditorIntents;
import com.nwagu.contacts.editor.EditorUiUtils;
import com.nwagu.contacts.interactions.ContactDeletionInteraction;
import com.nwagu.contacts.interactions.TouchPointManager;
import com.nwagu.contacts.lettertiles.LetterTileDrawable;
import com.nwagu.contacts.list.UiIntentActions;
import com.nwagu.contacts.logging.Logger;
import com.nwagu.contacts.logging.QuickContactEvent.ActionType;
import com.nwagu.contacts.logging.QuickContactEvent.CardType;
import com.nwagu.contacts.logging.QuickContactEvent.ContactType;
import com.nwagu.contacts.logging.ScreenEvent.ScreenType;
import com.nwagu.contacts.model.AccountTypeManager;
import com.nwagu.contacts.model.Contact;
import com.nwagu.contacts.model.ContactLoader;
import com.nwagu.contacts.model.RawContact;
import com.nwagu.contacts.model.account.AccountType;
import com.nwagu.contacts.model.dataitem.CustomDataItem;
import com.nwagu.contacts.model.dataitem.DataItem;
import com.nwagu.contacts.model.dataitem.DataKind;
import com.nwagu.contacts.model.dataitem.EmailDataItem;
import com.nwagu.contacts.model.dataitem.EventDataItem;
import com.nwagu.contacts.model.dataitem.ImDataItem;
import com.nwagu.contacts.model.dataitem.NicknameDataItem;
import com.nwagu.contacts.model.dataitem.NoteDataItem;
import com.nwagu.contacts.model.dataitem.OrganizationDataItem;
import com.nwagu.contacts.model.dataitem.PhoneDataItem;
import com.nwagu.contacts.model.dataitem.RelationDataItem;
import com.nwagu.contacts.model.dataitem.SipAddressDataItem;
import com.nwagu.contacts.model.dataitem.StructuredNameDataItem;
import com.nwagu.contacts.model.dataitem.StructuredPostalDataItem;
import com.nwagu.contacts.model.dataitem.WebsiteDataItem;
import com.nwagu.contacts.quickcontact.ExpandingEntryCardView.Entry;
import com.nwagu.contacts.quickcontact.ExpandingEntryCardView.EntryContextMenuInfo;
import com.nwagu.contacts.quickcontact.ExpandingEntryCardView.EntryTag;
import com.nwagu.contacts.quickcontact.ExpandingEntryCardView.ExpandingEntryCardViewListener;
import com.nwagu.contacts.quickcontact.WebAddress.ParseException;
import com.nwagu.contacts.util.DateUtils;
import com.nwagu.contacts.util.ImageViewDrawableSetter;
import com.nwagu.contacts.util.ImplicitIntentsUtil;
import com.nwagu.contacts.util.MaterialColorMapUtils;
import com.nwagu.contacts.util.MaterialColorMapUtils.MaterialPalette;
import com.nwagu.contacts.util.PhoneCapabilityTester;
import com.nwagu.contacts.util.SchedulingUtils;
import com.nwagu.contacts.util.SharedPreferenceUtil;
import com.nwagu.contacts.util.StructuredPostalUtils;
import com.nwagu.contacts.util.UriUtils;
import com.nwagu.contacts.util.ViewUtil;
import com.nwagu.contacts.widget.MultiShrinkScroller;
import com.nwagu.contacts.widget.MultiShrinkScroller.MultiShrinkScrollerListener;
import com.nwagu.contacts.widget.QuickContactImageView;
import com.nwagu.contactsbind.HelpUtils;
...
public class QuickContactActivity extends ContactsActivity {
    ...
    private static final String CALL_ORIGIN_QUICK_CONTACTS_ACTIVITY =
            "com.nwagu.contacts.quickcontact.QuickContactActivity";
    ...
    private static Entry dataItemToEntry(DataItem dataItem, DataItem secondDataItem,
        ...
        if (dataItem instanceof ImDataItem) {
            ...
            if (!TextUtils.isEmpty(phone.getNumber())) {
                ...
                phoneContentDescription = com.nwagu.contacts.util.ContactDisplayUtils
                ...
                smsContentDescription = com.nwagu.contacts.util.ContactDisplayUtils
